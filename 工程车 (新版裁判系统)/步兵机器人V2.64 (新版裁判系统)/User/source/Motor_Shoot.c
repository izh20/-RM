...
//PidTypeDef PluckPID;
ShootNumTypedef ShootNumber={0,0};    //需要射击的次数累计
 
//void PluckPIDInit(void)
//{
//	 
//	  PluckPID.Kp=8;   //2000  95转 *15 
//	  PluckPID.Ki=0;
//	  PluckPID.Kd=0;
//	  //PluckPID.AddMax=30;
...
//	 {   
//     
//		     Target=(int32_t)(15-PluckMotor.Circle)*400; 
