...
void test_task(void)
{
  ...
  Timetick1ms++;
    ...
    if((ShootNumber.Number>0)&&(ShootNumber.AllowShoot==0))
   {
       if(ShootNumber.LastFinish==0x00)  //如果上次发弹结束  
       {
